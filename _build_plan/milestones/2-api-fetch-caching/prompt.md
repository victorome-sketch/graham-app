...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/2-api-fetch-caching/milestone-log.md`). Structure it as follows:
